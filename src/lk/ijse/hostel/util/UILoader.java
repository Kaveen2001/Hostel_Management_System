...
public class UILoader {
    ...
    public static void loadUiDashBoard(AnchorPane anchorPane, String location) throws IOException {
        ...
        anchorPane.getChildren().clear();
        anchorPane.getChildren().add(FXMLLoader.load(Objects.requireNonNull(UILoader.class.getResource("/lk/ijse/hostel/view/" + location + ".fxml"))));
    }
    ...
    public static void LoginOnAction(AnchorPane anchorPane, String location) throws IOException, SQLException {
        ...
        Stage window = (Stage) anchorPane.getScene().getWindow();
        window.setScene(new Scene(FXMLLoader.load(Objects.requireNonNull(UILoader.class.getResource("/lk/ijse/hostel/view/" + location + ".fxml")))));
    }
    ...
    public static void NavigateToHome(AnchorPane anchorPane, String location) throws IOException, SQLException {
        ...
        primaryStage.setScene(new Scene(FXMLLoader.load(Objects.requireNonNull(UILoader.class.getResource("/lk/ijse/hostel/view/" + location + ".fxml")))));
        primaryStage.centerOnScreen();
        Platform.runLater(() -> primaryStage.sizeToScene());
    }
}