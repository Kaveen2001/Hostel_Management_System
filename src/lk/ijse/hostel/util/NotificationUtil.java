...
public class NotificationUtil {
    ...
    public static void SuccessfulTableNotification(String option, String option2) {
        Notifications notificationBuilder = Notifications.create()
                ...
                .graphic(new ImageView(new Image("/lk/ijse/hostel/view/images/done.png")))
    ...
    public static void UnSuccessfulTableNotification(String option, String option2) {
        Notifications notificationBuilder = Notifications.create()
                ...
                .graphic(new ImageView(new Image("/lk/ijse/hostel/view/images/error.png")))
                .hideAfter(Duration.seconds(8))
                .position(Pos.BOTTOM_RIGHT);
        notificationBuilder.darkStyle();
        notificationBuilder.show();
    ...
    public static void Warring(String option) {
        Notifications notificationBuilder = Notifications.create()
                .title("Warring..!")
                .text(option + " Not Login, Please enter Correct User Name or Password.Try Again.!")
                .graphic(new ImageView(new Image("/lk/ijse/hostel/view/images/error.png")))
    ...
    public static void WarringError(String option, Object id) {
        Notifications notificationBuilder = Notifications.create()
                .title("Warring Error..!")
                .text(option + id)
                .graphic(new ImageView(new Image("/lk/ijse/hostel/view/images/error.png")))
